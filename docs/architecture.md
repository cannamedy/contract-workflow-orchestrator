...
* `EngineeringArtifact` provides an optional typed artifact DAG. Generic generation/review/patch stages carry the artifact id and kind while skills provide content methods; deterministic CWO code owns lifecycle, dependency closure, candidate persistence, and validator hooks.
